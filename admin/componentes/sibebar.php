<aside id="sidebar" class="d-flex flex-column">
        ...
        <nav class="flex-grow-1 overflow-auto py-3">
            <ul class="nav flex-column gap-1">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="#submenuProdutos" data-bs-toggle="collapse" role="button" aria-expanded="false">
                    ...
                    <div class="collapse submenu" id="submenuProdutos">
                        <ul class="nav flex-column">
                            <li><a href="#" class="nav-link">Listar produtos</a></li>
                            <li><a href="#" class="nav-link">Novo produto</a></li>
                            <li><a href="#" class="nav-link">Estoque baixo</a></li>
                        </ul>
                    </div>
                </li>

                <li class="nav-item">
                    <a href="#" class="nav-link"><i class="bi bi-tags"></i> Categorias</a>
                </li>

                <li class="nav-item">
                    <a class="nav-link" href="#submenuEstoque" data-bs-toggle="collapse" role="button" aria-expanded="false">
                    ...
                    <div class="collapse submenu" id="submenuEstoque">
                        <ul class="nav flex-column">
                            ...
                            <li><a href="#" class="nav-link">Entrada de estoque</a></li>
                            <li><a href="#" class="nav-link">Saída de estoque</a></li>
                            <li><a href="#" class="nav-link">Inventário</a></li>
                        </ul>
                    </div>
                </li>

                <li class="nav-item"><a href="#" class="nav-link"><i class="bi bi-box-arrow-in-right"></i> Entradas</a></li>
                <li class="nav-item"><a href="#" class="nav-link"><i class="bi bi-box-arrow-left"></i> Saídas</a></li>
                <li class="nav-item"><a href="#" class="nav-link"><i class="bi bi-truck"></i> Fornecedores</a></li>
                <li class="nav-item"><a href="#" class="nav-link"><i class="bi bi-people"></i> Clientes</a></li>
                <li class="nav-item"><a href="#" class="nav-link"><i class="bi bi-cart3"></i> Pedidos</a></li>
                ...
                <li class="nav-item"><a href="#" class="nav-link"><i class="bi bi-person-gear"></i> Usuários</a></li>
                <li class="nav-item"><a href="#" class="nav-link"><i class="bi bi-gear"></i> Configurações</a></li>
                <li class="nav-item mt-4"><a href="#" class="nav-link text-danger"><i class="bi bi-box-arrow-right"></i> Sair</a></li>
            </ul>
        </nav>
    </aside>